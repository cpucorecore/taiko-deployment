...
from=${TEST_ADDR_L2}
srcChainId=0
srcOwner=${TEST_ADDR_L2}
destChainId=${CHAIN_ID_L1}
destOwner=${TEST_ADDR_L2} # self
to=${TEST_ADDR_L2}
value=${bridge_amount}
data=0x
...
echo "before bridge asset from l2 to l1:"
printf "%s balance on l1:" ${TEST_ADDR_L2}
cast balance -r ${RPC_URL_L1} ${TEST_ADDR_L2}
printf "%s balance on l2:" ${TEST_ADDR_L2}
cast balance -r ${RPC_URL_L2} ${TEST_ADDR_L2}

cast send \
--value ${total_value} \
-r ${RPC_URL_L2} \
--private-key ${TEST_SK_L2} \
${ADDR_BRIDGE_L2} \
